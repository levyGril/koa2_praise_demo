...
var ThumbButton = function (_PraiseButton) {
    ...
    function ThumbButton(num, element) {
        _classCallCheck(this, ThumbButton);

        return _possibleConstructorReturn(this, (ThumbButton.__proto__ || Object.getPrototypeOf(ThumbButton)).call(this, num, element));
    }

    return ThumbButton;
}(_PraiseButton3.default);

exports.default = { ThumbButton: ThumbButton };